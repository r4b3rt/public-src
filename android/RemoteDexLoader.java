...
public class RemoteDexLoader extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String[] params) {
        ...
        DexClassLoader cl = new DexClassLoader(localName,
                dataDir, null, this.getClass().getClassLoader());
        try {
            Class<?> demoDexClass = cl.loadClass("com.demoapk.Logger");
...
//                demoInterface.test();
    ...
    public void URLDownloadToFile(final String urlString, final String filename)
